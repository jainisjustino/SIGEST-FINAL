...
<body>
  ...
  <div class="container">
    <form  method="POST" action="-novoProcessa.php?id=<?php echo $paciente_id; ?>" onsubmit="return confirm('Deseja editar esses dados?');">
      <div class="div1">
      ...
      <div class="div2">
        ...
        <input type="number" id="cpf" name="cpf" value="<?php echo $paciente['cpf']; ?>" required>
      </div>
      ...
      <div class="div3">
        ...
        <input type="date" id="dn" name="dn" value="<?php echo $paciente['dn']; ?>" required>
      </div>
      ...
      <div class="div2">
        ...
        <input type="number" id="fone" name="fone" value="<?php echo $paciente['fone']; ?>" required>
      </div>

      <div class="div6">
        <label for="endereco">Endereço</label>
        <input type="text" id="endereco" name="endereco" value="<?php echo $paciente['endereco']; ?>" required>
      </div>
      <div class="div8">
      ...
      <div class="div8">
        ...
        <textarea id="avaliacao" name="avaliacao"><?php echo $paciente['avaliacao']; ?></textarea>
      </div>
...
<div class="tratamento">
    <div class="div12">
        ...
        <input type="date" id="nova_data" name="nova_data[]">
    </div>
    <div class="div13">
        <label for="novo_tratamentoRealizado">Tratamento realizado</label>
        <input type="text" id="novo_tratamentoRealizado" name="novo_tratamentoRealizado[]">
    </div>
    <div class="div14">
        <label for="novo_dente">Dente</label>
        <input type="number" id="novo_dente" name="novo_dente[]">
    </div>
    <div class="div15">
        <label for="novo_formaPagamento">Forma pagamento</label>
        <input type="text" id="novo_formaPagamento" name="novo_formaPagamento[]">
    </div>
    <div class="div16"> 
        <label for="novo_saldo">Saldo</label>
        <input type="text" id="novo_saldo" name="novo_saldo[]">
    </div>
</div>
    ...
    <a href="rel.php?id=<?php echo $paciente_id; ?>" class="btnrelatorio">Relatório</a>
