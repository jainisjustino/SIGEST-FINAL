...
<body>
  ...
  <div class="container">
    ...
    <form  method="POST" action="processaUpdate.php?id=<?php echo $paciente_id; ?>" onsubmit="return confirm('Deseja editar esses dados?');">
      ...
      <?php foreach ($tratamentos as $tratamento) { ?>
        ...
        <div class="div12">
          ...
          <input type="date" id="data" name="data" value="<?php echo $tratamento['data']; ?>">
        </div>

        <div class="div13">
        <label for="tratamentoRealizado">Tratamento realizado</label>
        <input type="text" id="tratamentoRealizado" name="tratamentoRealizado" value="<?php echo $tratamento['tratamentoRealizado']; ?>">
      </div>

      <div class="div14">
        <label for="dente">Dente</label>
        <input type="number" id="dente" name="dente" value="<?php echo $tratamento['dente']; ?>">
      </div>

      <div class="div15">
        <label for="formaPagamento">Forma pagamento</label>
        <input type="text" id="formaPagamento" name="formaPagamento" value="<?php echo $tratamento['formaPagamento']; ?>">
      </div>

      <div class="div16"> 
        <label for="saldo">Saldo</label>
        <input type="text" id="saldo" name="saldo" value="<?php echo $tratamento['saldo']; ?>">
      </div>
    ...
    <a class="btnrelatorio" href="relatorio.php?id=<?php echo $paciente_id; ?>">Relatório</a>
