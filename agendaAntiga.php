...
<body>
    ...
    <form method="POST" action="agenda.php">
        ...
        <input type="datetime-local" name="dataHora" min="2023-01-01T07:00" max="2023-12-31T20:00" step="900" required><br> <!-- 900 segundos = 15 minutos -->
    ...
    <table>
        <tr>
            ...
            <?php
            $dataInicio = strtotime(date("Y-01-01 07:00:00")); // Primeiro dia do ano às 07:00
